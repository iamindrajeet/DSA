...
public class MinInsertDeleteToMakeStringPalindrome {
	public static void main(String[] args) {
		...
		int shortestCommonSupersequence = Math.abs(m + n - lcs);
		int minInsertOrDeleteReq = Math.abs(m - shortestCommonSupersequence);
		System.out.println(minInsertOrDeleteReq);
	}
