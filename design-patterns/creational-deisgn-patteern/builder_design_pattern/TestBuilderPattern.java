 ...
 * There are three major issues with Factory and Abstract Factory design patterns when the Object contains a lot of attributes.
	...
	We can solve the issues with large number of parameters by providing a constructor with required parameters and 
		...
		will be inconsistent until unless all the attributes are set explicitly. 
...
public class TestBuilderPattern {
	...
	public static void main(String[] args) {
		...
		Computer.ComputerBuilder computerBuilder = new Computer.ComputerBuilder("500 GB", "2 GB");
		Computer computer = computerBuilder.setIsBluetoothEnabled(false).setIsGraphicsCardEnabled(true).build();
